    ...
    <div>
      <section className="flex flex-col gap-1">
                  <div className="mt-12">
                    ...
                    <h1 className="flex flex-col gap-3 font-outfit text-6xl lg:text-8xl text-center sm:text-start font-medium mt-5 leading-none text-gray-900">
                      Arquiteta & Urbanista
                  ...
                  <ul className="flex flex-col gap-2.5 font-medium mt-8 lg:mt-10 mb-2 text-gray-900 text-lg lg:text-xl">
                    ...
                    <p className="text-lg lg:text-xl text-gray-700 mt-6 max-w-[48ch]">
